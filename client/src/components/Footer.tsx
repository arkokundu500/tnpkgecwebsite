        ...
        <footer className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-950 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    {/* College Info */}
                    <div>
                        <h3 className="text-xl font-bold mb-4">KGEC T&amp;P Cell</h3>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mb-6">
                            <a
                                href="https://www.linkedin.com/company/tnpkgec"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-lg bg-blue-800/50 flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:scale-110"
                                title="LinkedIn"
                            >
                            ...
                            <a
                                href="https://www.facebook.com/tnp.kgec/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-lg bg-blue-800/50 flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:scale-110"
                                title="Facebook"
                        ...
                        <p className="text-blue-300 text-xs">
                            Building bridges between academia and industry since 1995.
                        </p>
                    </div>
                </div>
                ...
                <div className="border-t border-blue-700/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-blue-300 text-sm">
                        © {new Date().getFullYear()} KGEC Training &amp; Placement Cell. All
                        rights reserved.
                    </p>
                    <p className="text-blue-400 text-xs">
                        Designed by Arko Kundu
                    </p>
                </div>
            </div>
        </footer>
